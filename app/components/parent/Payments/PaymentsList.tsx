...
export function PaymentsList({ childId }: PaymentsListProps) {
    ...
    const fetchPayments = useCallback(async () => {
        try {
            ...
            const url = childId ? `/api/payments?childId=${childId}` : "/api/payments";
    ...
    const totalOutstanding = upcomingPayments.reduce(
    ...
    const handlePay = async (payment: ApiPayment) => {
        ...
        try {
            ...
            showModal(
                "success",
                `Opłata została zarejestrowana. Kwota: ${payment.amount.toLocaleString(
                    "pl-PL",
                    {
                        style: "currency",
                        currency: "PLN",
            ...
            <div className="flex flex-wrap gap-3">
                <div className="flex items-center gap-2 rounded-lg border border-blue-200 bg-blue-50 px-4 py-2 text-sm text-blue-700">
                    ...
                    <strong className="text-blue-900">
                        {totalOutstanding.toLocaleString("pl-PL", {
                            style: "currency",
                            currency: "PLN",
                        })}
                    </strong>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500">
                                Opłać wybrany miesiąc online lub zaznacz jako uregulowane po
                                wykonaniu przelewu.
                            </p>
                        </div>
                    </div>
